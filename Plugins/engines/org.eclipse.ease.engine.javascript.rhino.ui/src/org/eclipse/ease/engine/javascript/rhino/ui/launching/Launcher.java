...
import org.eclipse.ease.engine.javascript.rhino.debugger.RhinoDebugger;
...
public class Launcher extends AbstractLaunchDelegate {
	...
	protected IScriptEngine getScriptEngine(final ILaunchConfiguration configuration, final String mode) {
		...
		return scriptService.createEngineByID("org.eclipse.ease.javascript.rhino");
	}

	@Override
	protected String getLaunchConfigurationType() {
		return "org.eclipse.ease.launchConfigurationType.rhino";
	}
