 ...
 * <ul>
 *   <li>{@link org.eclipse.ease.ui.repository.impl.EntryImpl#getTimestamp <em>Timestamp</em>}</li>
...
public class EntryImpl extends LocationImpl implements IEntry {
	...
	public void setTimestamp(long newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IRepositoryPackage.ENTRY__TIMESTAMP, oldTimestamp, timestamp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IRepositoryPackage.ENTRY__TIMESTAMP:
				return getTimestamp();
