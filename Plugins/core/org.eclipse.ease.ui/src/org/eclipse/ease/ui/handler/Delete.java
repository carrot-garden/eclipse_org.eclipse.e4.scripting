...
public class Delete extends AbstractHandler implements IHandler {
    ...
    public static final String COMMAND_ID = "org.eclipse.ease.commands.macro.delete";
    public static final String PARAMETER_NAME = "org.eclipse.ease.commands.macro.delete.name";
