...
public class Edit extends AbstractHandler implements IHandler {
    ...
    public static final String COMMAND_ID = "org.eclipse.ease.commands.macro.edit";
    public static final String PARAMETER_NAME = "org.eclipse.ease.commands.macro.edit.name";
