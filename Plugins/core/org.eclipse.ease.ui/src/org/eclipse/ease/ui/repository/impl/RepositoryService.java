...
public class RepositoryService implements IRepositoryService {
	...
	static final long UPDATE_URI_INTERVAL = 1000 * 60 * 60 * 24; // update daily
	static final long UPDATE_SCRIPT_INTERVAL = 1000 * 60 * 60; // update hourly
	...
	public Collection<IScript> getScripts() {
		return getRepository().getScripts();
	}
