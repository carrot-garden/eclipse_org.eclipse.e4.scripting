...
import org.eclipse.ease.ui.actions.EditScriptAction;
import org.eclipse.ease.ui.actions.RefreshStoredScriptAction;
import org.eclipse.ease.ui.actions.RunScriptAction;
import org.eclipse.ease.ui.scriptuigraph.Node;
import org.eclipse.ease.ui.scriptuigraph.StoredScriptUI;
import org.eclipse.ease.ui.scriptuigraph.provider.ScriptCellLabelProvider;
...
public class ScriptEplorerView extends ViewPart {
	...
	public static final String ID = "org.eclipse.ease.ui.view.ScriptEplorerView"; //$NON-NLS-1$
	...
	private void createActions() {
		// Create the actions
		{
			...
			playScriptAction.setEnabled(false);
			playScriptAction.setDisabledImageDescriptor(ResourceManager.getPluginImageDescriptor("org.eclipse.ease.ui", "images/start_script_disable.gif"));
			playScriptAction.setImageDescriptor(ResourceManager.getPluginImageDescriptor("org.eclipse.ease.ui", "images/start_script.gif"));
		}
		{
			editScriptAction = new EditScriptAction("Edit Script");
			editScriptAction.setImageDescriptor(ResourceManager.getPluginImageDescriptor("org.eclipse.ease.ui", "images/editor.gif"));
			editScriptAction.setEnabled(false);
		}
		{
			refreshStoreAction = new RefreshStoredScriptAction("Edit Script");
			refreshStoreAction.setImageDescriptor(ResourceManager.getPluginImageDescriptor("org.eclipse.ease.ui", "images/refresh.gif"));
		...
		}
		{
			...
			expandAllAction.setImageDescriptor(ResourceManager.getPluginImageDescriptor("org.eclipse.ease.ui", "icons/full/obj16/expandall.gif"));
		}
		{
			...
			collapseAll.setImageDescriptor(ResourceManager.getPluginImageDescriptor("org.eclipse.ease.ui", "icons/full/obj16/collapseall-1.gif"));
		}
	}
