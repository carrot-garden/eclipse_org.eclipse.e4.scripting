 ...
 *******************************************************************************/
package org.eclipse.ease.ui.e4;
...
import org.eclipse.ease.ui.e4.handler.IFragmentConstants;
...
import org.eclipse.ease.ui.expression.ExpressionToExpressionCoreSwitch;
import org.eclipse.ease.ui.expression.xtext.CoreExpressionStandaloneSetupGenerated;
import org.eclipse.ease.ui.expression.xtext.parser.antlr.CoreExpressionParser;
...
public class ScriptDynamicContribution {
	...
	protected boolean visible(IStoredScript script, IEvaluationContext context) {
		...
		if(root instanceof org.eclipse.ease.ui.expression.coreexpression.Root) {
			org.eclipse.ease.ui.expression.coreexpression.Root exp = (org.eclipse.ease.ui.expression.coreexpression.Root)root;
