 ...
 *******************************************************************************/
package org.eclipse.ease.storedscript.service;
...
import org.eclipse.ease.storedscript.service.impl.StoredScriptService;
...
public interface IStoredScriptService {
	...
	public abstract org.eclipse.ease.storedscript.storedscript.ScriptType getScriptType(String type);

	public abstract org.eclipse.ease.storedscript.storedscript.ScriptType getMatchingScriptType(IStoredScript script);
