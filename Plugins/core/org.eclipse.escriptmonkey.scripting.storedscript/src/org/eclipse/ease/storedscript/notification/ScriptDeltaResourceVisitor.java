 ...
 *******************************************************************************/
package org.eclipse.ease.storedscript.notification;
...
public class ScriptDeltaResourceVisitor implements IResourceDeltaVisitor {
	...
	public boolean visit(IResourceDelta delta) throws CoreException {
		...
		if(resource instanceof IFile) {
			...
			if(org.eclipse.ease.storedscript.utils.ScriptResourceUtils.isEclipseMonkeyResource(file)) {
	...
	protected void handleScriptResourceChange(IResourceDelta delta, IFile file) {
		//		URI fileURI = org.eclipse.ease.storedscript.utils.URIScriptUtils.getAbsoluteURI(delta);
