...
public class CoreExpressionGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class IterableExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cOperandOperatorParserRuleCall_3_1_0 = (RuleCall)cOperandAssignment_3_1.eContents().get(0);
		...
		//IterableExpression:
		//	{IterableExpression} ifEmpty?="ifEmpty"? "Iterable" ("operator" operand=Operator)? "{" (expressions+=Expression (","
		//	expressions+=Expression)*)? "}";
		public ParserRule getRule() { return rule; }
		...
		//Operator
		public RuleCall getOperandOperatorParserRuleCall_3_1_0() { return cOperandOperatorParserRuleCall_3_1_0; }
