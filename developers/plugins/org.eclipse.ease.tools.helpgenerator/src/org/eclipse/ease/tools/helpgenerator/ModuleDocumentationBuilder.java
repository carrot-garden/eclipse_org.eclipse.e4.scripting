...
public class ModuleDocumentationBuilder extends IncrementalProjectBuilder {
	...
	public static final String BUILDER_ID = "org.eclipse.ease.helpgenerator";
	...
	protected IProject[] build(final int kind, final Map<String, String> args, final IProgressMonitor monitor) throws CoreException {
		try {
			...
			// TODO extract source folders from project and add them dynamically
			parameters.add("-subpackages");
			parameters.add("com:org");
			parameters.add("-doclet");
			parameters.add("org.eclipse.ease.tools.helpgenerator.JavascriptDoclet");
			...
			try {
				Main.execute("EASE Documentation Generator", parameters.toArray(new String[parameters.size()]));
